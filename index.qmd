...
<div class="sk-about-page">
  ...
  <section class="sk-about-section" id="selected-presentations">
    ...
    <div class="sk-activity-list">
      <article class="sk-activity">
        <div>
          <h3>Spring Conference of the Korean Chemical Society</h3>
      ...
      <article class="sk-activity">
        <div>
          <h3>Research Presentation for Chemistry Department Workshop</h3>
          <p>Chiral Indenyl Rh-Catalyzed Enantioselective Olefin 1,2-Arylamination</p>
        </div>
        <div class="sk-activity-meta">
      ...
      <article class="sk-activity">
        <div>
          <h3>Future Chemists Research Conference of the Korean Chemical Society</h3>
      ...
      <article class="sk-activity">
        <div>
          <h3>Thailand International Science Fair</h3>
      ...
      <article class="sk-activity">
        <div>
          <h3>Autumn Conference of the Korean Polymer Society</h3>
          <p>Improvement of Gas Adsorption Efficiency of Fragile Porphyrin-based MOFs</p>
        </div>
        <div class="sk-activity-meta">
          <span>Poster presentation</span>
      ...
      <article class="sk-activity">
        <div>
          <h3>Japan Super Science Fair</h3>
  ...
  <section class="sk-about-section" id="honors-and-awards">
    ...
    <div class="sk-activity-list">
      ...
      <article class="sk-activity">
        <div>
          <h3>Talent Award of Korea</h3>
          <p>National Prize, Ministry of Education, Republic of Korea.</p>
      ...
      <article class="sk-activity">
        <div>
          ...
          <p>Scholarship Foundation for Korea Science Academy.</p>
        </div>
        <div class="sk-activity-meta">
          <span>2021</span>
        </div>
      ...
      <article class="sk-activity">
        <div>
          <h3>Gold Prize</h3>
          <p>World Invention Creativity Olympic (WICO).</p>
        </div>
        <div class="sk-activity-meta">
          <span>2017</span>
        </div>
